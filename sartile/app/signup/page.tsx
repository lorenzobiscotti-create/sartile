...
const pageStyles = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .auth-plan-badge {
    ...
    background: rgba(0,196,180,0.1); border: 1px solid rgba(0,196,180,0.3);
    border-radius: 999px; padding: 6px 14px;
    font-size: 13px; font-weight: 600; color: var(--teal); width: fit-content;
  }
  ...
  .auth-terms { font-size: 12.5px; color: var(--muted-slate); text-align: center; line-height: 1.6; }
  .auth-terms a { color: var(--slate); font-weight: 500; text-decoration: none; }
...
const PLAN_LABELS: Record<string, string> = {
  ...
  founder: 'Founder — $9/mo',
  partner: 'Partner — $19/mo',
}
...
function SignupContent() {
  ...
  async function signUpWithGoogle() {
    ...
    const next = `/onboarding${params.toString() ? '?' + params.toString() : ''}`
      ...
      <div className="auth-page">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <h1 className="auth-title">Start building your brand.</h1>
            <p className="auth-sub">Create your free account and meet sarti.</p>
